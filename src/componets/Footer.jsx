            ...
            <footer>
                <div className="content">
                    <div className="top">
                        <div className="log-details">
                            <i className='bx bxs-home' style={{ color: "#fff" }}></i>
                            <span className="logo_name">Pawan Pvt</span>
                        </div>
                    ...
                    <div className='line-boxes'>
                        ...
                        <ul className='box input-box'>
                            <li className='link-name'>Suscribe Us</li>
                            <li><input type="text" placeholder='Enter your Email'></input></li>
                            <li><button type='sumit'>Subscribe</button></li>
                        </ul>
                    </div>
                ...
                <div className='bottom-details'>
                        <div className='bottom-text'>
                            <span className='copy-right-text'>Copyright &#169; 2025 <Link to='#'>Pawan Pvt.</Link>All rights regerved</span>
                            <span className='privicy-policy-text'>
